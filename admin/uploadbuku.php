...
<div class="relative">
    <!-- Trigger -->
    <button onclick="toggleAdminDropdown()" class="flex items-center space-x-3 bg-white text-black px-4 py-2 rounded-full">
        <img src="https://via.placeholder.com/50" alt="Foto Admin" class="w-10 h-10 rounded-full object-cover">
        <span><?php echo htmlspecialchars($adminName); ?></span>
    </button>

    <!-- Dropdown Menu -->
    <div id="adminDropdownMenu" class="hidden absolute right-0 mt-2 w-64 bg-white text-black rounded-lg shadow-lg">
        <!-- Admin Profil -->
        <div class="flex items-center p-4 border-b border-gray-700">
            <img src="https://via.placeholder.com/50" alt="Foto Admin" class="w-12 h-12 rounded-full object-cover">
            <div class="ml-3">
                <h2 class="font-semibold"><?php echo htmlspecialchars($adminName); ?></h2>
                <p class="text-gray-400 text-sm"><?php echo htmlspecialchars($adminEmail); ?></p>
                <a href="admin_profil.php" class="text-blue-400 text-sm hover:underline">Lihat Profil</a>
            </div>
        </div>
        ...
        <ul class="py-2 text-sm">
            <li>
                <a href="edit_admin.php" class="block px-4 py-2 hover:bg-gray-700">Edit Profil</a>
            </li>
            <li>
                <a href="manage_admins.php" class="block px-4 py-2 hover:bg-gray-700">Kelola Admin</a>
            </li>
            <li>
