...
<head>
    ...
    <style>
        /* Pastikan halaman memenuhi tinggi layar */
        html, body {
            height: 100%;
            margin: 0;
            display: flex;
        ...
        main {
            flex: 1; /* Konten utama mengisi ruang di tengah */
        }
    </style>
</head>
<body class="bg-gray-200 text-gray-800">
    ...
    <!-- Ikon Ceklis -->
    <div class="w-32 h-32 mb-6 rounded-full flex items-center justify-center">
        <img src="checklist.png" alt="Checklist" class="w-full h-full object-cover">
    </div>

    <!-- Teks Sukses -->
    <h2 class="text-2xl font-bold mb-4 text-gray-800">Pembayaran Berhasil!</h2>
    <p class="text-lg mb-8 text-gray-600">Terima kasih telah melakukan pembayaran.</p>

    
<!-- Tombol Aksi -->
<div class="flex justify-center gap-4 mt-4">
    <button onclick="window.location.href='chattkurir.php'" 
            class="bg-gray-800 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition duration-300">
        Chat Kurir
    </button>

    <button onclick="window.location.href='beranda.php'" 
            class="bg-gray-800 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition duration-300">
        Kembali
    </button>
</div>
