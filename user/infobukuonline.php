...
    }
    ...
    <div class="container mx-auto mt-8 px-4">
        ...
        <div class="text-center mt-6 space-x-4">
            <button class="bg-blue-500 text-white py-2 px-6 rounded hover:bg-blue-600" onclick="window.location.href='ebook.php'">Baca Buku Online</button>
            <button class="bg-blue-500 text-white py-2 px-6 rounded hover:bg-blue-600" onclick="window.location.href='ebook.php'">Baca Offline</button>
