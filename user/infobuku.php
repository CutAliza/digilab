...
<div class="text-center mt-6 space-x-4">
    <button class="bg-blue-500 text-white py-2 px-6 rounded hover:bg-blue-600" onclick="window.location.href='infobukuonline.php'">Baca Online</button>
    <button class="bg-blue-500 text-white py-2 px-6 rounded hover:bg-blue-600" onclick="window.location.href='infobukuperpust.php'">Baca Offline</button>
</div>
