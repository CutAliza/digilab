...
<body class="bg-gradient-to-r from-gray-500 to-blue-900">
    ...
    <div class="max-w-lg mx-auto my-12 p-6 bg-gray-100 rounded-xl">
        ...
        <!-- Login Form -->
        <h4 class="text-xl font-semibold mb-4 text-center">Sign In</h4>
        ...
        <div class="mt-8 text-center">
            ...
            <div class="space-y-4">
            <button class="w-full py-3 bg-white text-gray-800 border border-gray-300 rounded-xl hover:bg-gray-100"onclick="location.href='logingoogle.php'">
                <i class="bi bi-google mr-2"></i><strong>Google</strong>
            </button>
                <button class="w-full py-3 bg-white text-gray-800 border border-gray-300 rounded-xl hover:bg-gray-100"onclick="location.href='loginapple.php'">
