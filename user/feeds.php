...
<head>
    ...
    <title>Open Library Telkom University</title>
    ...
    <div class="container mx-auto mt-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-4">
            ...
            <div class="bg-gray-200 rounded-lg my-4 overflow-hidden">
                <img src="feeds.jpg" alt="Logo" class="w-full h-64 object-cover">
            </div>
            ...
            <div class="flex justify-around mt-4">
                <button class="flex items-center space-x-2 hover:text-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M10 3a7 7 0 100 14h4a4 4 0 100-8h-4zM3 8h4a4 4 0 100-8H3a4 4 0 100 8z" />
                    </svg>
                    <span>Suka</span>
                </button>
                <button class="flex items-center space-x-2 hover:text-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M15 8a3 3 0 01-6 0V6a3 3 0 116 0v2zM6 11a4 4 0 1111 3.9V17a2 2 0 01-2 2H7a2 2 0 01-2-2v-2.1A4 4 0 016 11z" />
                    </svg>
                    <span>Komentar</span>
                </button>
                <button class="flex items-center space-x-2 hover:text-gray-700">
