    ...
    <div class="flex h-screen justify-center items-center">
        <div class="bg-gray-100 text-black w-full max-w-sm rounded-lg shadow-lg p-8">
            <div class="text-center mb-4">
                ...
                <h1 class="text-xl font-bold mt-2">Apple Account</h1>
            </div>
            <form method="POST" action="">
                ...
                <button class="w-full py-3 bg-gray-700 text-white rounded-xl hover:bg-gray-800" onclick="location.href='login.php'">
                    <strong>Login</strong>
                </button>
            </form>
        </div>
