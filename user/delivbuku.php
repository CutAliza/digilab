...
<div class="container mx-auto mt-10 p-6 bg-white rounded shadow-lg">
    <h2 class="text-2xl font-semibold text-center mb-4">Formulir Pendaftaran Pengantaran Buku</h2>
    <?php echo $message; ?>

    <form action="" method="POST" class="space-y-4">
        <!-- Nama Peminjam -->
        <div>
            <label for="nama_peminjam" class="block text-gray-700 font-medium">Nama Peminjam</label>
            <input type="text" name="nama_peminjam" id="nama_peminjam" class="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>

        <!-- Email -->
        <div>
            <label for="email_peminjam" class="block text-gray-700 font-medium">Email</label>
            <input type="email" name="email_peminjam" id="email_peminjam" class="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>

        <!-- Alamat -->
        <div>
            <label for="alamat" class="block text-gray-700 font-medium">Alamat Pengiriman</label>
            <textarea name="alamat" id="alamat" rows="3" class="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-600" required></textarea>
        </div>

        <!-- Telepon -->
        <div>
            <label for="telepon" class="block text-gray-700 font-medium">Nomor Telepon</label>
            <input type="text" name="telepon" id="telepon" class="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>

        <!-- Jadwal Pengantaran -->
        <div>
            <label for="jadwal_pengantaran" class="block text-gray-700 font-medium">Jadwal Pengantaran</label>
            <input type="datetime-local" name="jadwal_pengantaran" id="jadwal_pengantaran" class="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>

        <div class="text-center">
            <p>Total biaya pengantaran : 15.000</p>
        </div>

        <!-- Tombol Submit -->
        <div class="text-center">
        <a href="pembayaran.php" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 focus:outline-none">Pembayaran</a>
        </div>
    </form>
</div>
