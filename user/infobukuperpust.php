...
    }
    ...
    <div class="container mx-auto mt-8 px-4">
        ...
        <div class="text-center mt-6 space-x-4">
            <button onclick="window.location.href='layanan.php'" class="bg-blue-500 text-white py-2 px-6 rounded hover:bg-blue-600">Ambil ke Perpustakaan
            </button>
            <button onclick="window.location.href='delivbuku.php'" class="bg-blue-500 text-white py-2 px-6 rounded hover:bg-blue-600">Delivery Buku
        </button>
</div>
